...
# def Main ():
#     T0 = time()
#     Sentences = [';'.join(l.strip().split(';')[:-2]) for l in open ('RestAspTermABSA.data').xreadlines()]#[:20]
#     Term = [l.strip().split(';')[-2] for l in open ('RestAspTermABSA.data').xreadlines()]
#     Label = [l.strip().split(';')[-1] for l in open ('RestAspTermABSA.data').xreadlines()]
